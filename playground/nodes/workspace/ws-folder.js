...
import {WSFile} from './factory.js'
import {LARL, Path} from '../../../core/types/arl'
...
WSFolder.prototype = {
    ...
    toJSON() {
        ...
        if (this.parent.parent.parent) return ' ' + this.arl.getPath()

        // root folders are either expanded or not..
        return this.is.expanded ? '+' + this.arl.getPath() : '-' + this.arl.getPath()
    },
