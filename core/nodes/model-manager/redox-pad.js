...
changeNamePad: {
    ...
    doit({view, pad}) {
        ...
        //save the edit
        this.saveEdit('changeNamePad',{pad, oldName: pad.text, newName: null})
    ...
    undo({pad, oldName, newName}) {
        // save the new name
        this.saveEdit().newName = pad.text
...
padDrag: {
    ...
    doit({pad,oldPos, oldWires,newPos,newWires}) {
        // save the route points for the undo-operation
        this.saveEdit('padDrag',{ pad,
