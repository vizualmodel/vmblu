...
test('artifact provenance is deterministic and insensitive to object key order', () => {
    const first = {header: {version: '0.10.0'}, root: {name: 'App', kind: 'group'}}
    const second = {root: {kind: 'group', name: 'App'}, header: {version: '0.10.0'}}
...
test('application and capability generators embed current deterministic provenance', () => {
    ...
    model.raw = {
        header: {version: '0.10.0', runtime: '@vizualmodel/vmblu-runtime/rt-base'},
